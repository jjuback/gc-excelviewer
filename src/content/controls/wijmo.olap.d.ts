...
declare module wijmo.olap {
    ...
    class CubePivotField extends PivotField {
        ...
        /**
         * Initializes a new instance of the @see:CubePivotField class.
         *
         * @param engine @see:PivotEngine that owns this field.
         * @param binding Property that this field is bound to.
         * @param header Header shown to identify this field (defaults to the binding).
...
declare module wijmo.olap {
    ...
    class PivotEngine {
         ...
         * service.
         *
         * The first option (using an array or @see:ICollectionView) is the
         ...
         *
         * To use this option, simply set the @see:itemsSource property to
         ...
         * the @see:PivotEngine to connect directly to OLAP cubes provided
         ...
         * of records.
         *
         * To use this option, set the @see:itemsSource property to an object
         ...
         * OLAP Cubes.
         *
         * To use ComponentOne data engine services, set the @see:itemsSource
         ...
         * sample shows all options working with a single @see:PivotEngine.
         */
        itemsSource: any;
        /**
         * Gets a value that determines whether the engine is bound to a server
         * @see:itemsSource or is using local data.
         */
         ...
         * property of the items in the @see:itemsSource. The @see:PivotField.binding
         * property of the auto-generated fields is set to the property name, and their
         * @see:PivotField.header property is set to a string obtained by capitalizing
         ...
         * with @see:PivotField.binding set to 'customerName' and @see:PivotField.header
...
declare module wijmo.olap {
    /**
     * Generates MDX queries for the @see:_SqlServerConnection class.
     */
    class _MdxQueryBuilder {
        private _ng;
        private _cubeName;
        /**
         * Initializes a new instance of the @see:_MdxQueryBuilder class.
         *
         * @param engine @see:PivotEngine from which to derive a query.
         * @param cubeName Name of the cube to be queried.
         */
        constructor(engine: PivotEngine, cubeName: string);
        /**
         * Builds the MDX query according to information from the @see:PivotEngine.
         */
        buildQuery(): string;
        /**
...
declare module wijmo.olap {
    ...
    class _SqlServerConnection extends _ServerConnection {
        ...
        private _debug;
        /**
         * Initializes a new instance of the @see:_SqlServerConnection class.
         *
         * @param engine @see:PivotEngine that owns this field.
...
declare module wijmo.olap {
    ...
    class _TextBuilder {
        private _text;
        /**
         * Initializes a new instance of the @see:_TextBuilder class.
         */
        constructor();
        /**
